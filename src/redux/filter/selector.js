...
export const selectRefrigerator = (state) => state.filter.refrigerator;
export const selectMicrowave = (state) => state.filter.microwave;
export const selectGas = (state) => state.filter.gas;
export const selectWater = (state) => state.filter.water; */
